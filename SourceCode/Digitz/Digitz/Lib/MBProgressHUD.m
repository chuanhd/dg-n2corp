...
- (void)updateIndicators {
    ...
    if (self.cancelable) {
        UITapGestureRecognizer *gesture = MB_AUTORELEASE([[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(handleTap:)]);
        gesture.numberOfTapsRequired = 1;
        [self.indicator addGestureRecognizer:gesture];
        gesture = nil;
    }
}
...
//	}
	...
	CGSize labelSize = [_label.text sizeWithFont:_label.font constrainedToSize:CGSizeMake(280, 9999) lineBreakMode:UILineBreakModeWordWrap];
